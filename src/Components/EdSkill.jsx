...
import { FaBootstrap, FaCss3, FaHtml5, FaReact, FaPhp } from "react-icons/fa";
import { SiExpress, SiFigma, SiGit, SiGithub, SiJavascript, SiNodedotjs, SiRedux, SiTailwindcss, SiMysql } from 'react-icons/si'
...
const EdSkill = () => {
    ...
    return (
        <div name="Skills" className="w-full sm:h-screen md:h-screen sm:py-[40%] pt-[15%] bg-gradient-to-b from-gray-800 to-black text-white">
            ...
            <div className="max-w-screen-lg p-2 mx-auto flex flex-col justify-center w-full h-full text-white">
                ...
                <div className="pb-1">
                    ...
                    <p className="p-6">
                        These are the technologies I've and I am learning yet..!
                    </p>
                </div>

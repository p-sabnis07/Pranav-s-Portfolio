...
const Home = () => {
    ...
    return (
        <div name="Home" className='w-full pt-12 pb-14 sm:h-screen
         bg-gradient-to-b from-black to-gray-800 via-black'>
            ...
            <div className='max-w-screen-md mx-auto flex flex-col items-center justify-center h-full px-4 sm:flex-row sm:ml-12 md:mx-auto'>
                <div className='flex flex-col justify-center h-full pt-10'>
                   ...
                   >I'm a Front-End Developer
                    ...
                    <p className='text-gray-500 py-4  max-w-md'>
                        ...
                        to innovative technologies, creating websites and applications.

                    </p>

                    <div>
                        <Link to="Projects" smooth duration={500} className='w-fit text-white px-6 py-3 my-5 flex items-center cursor-pointer rounded-md bg-gradient-to-r from-purple-700 to-orange-600 font-bold'>
                            Projects
                ...
                <div>
                    <img src={Pranav} alt="Pranav" className='rounded-2xl mx-auto w-2/3 sm:w-2/3 md:w-2/3 md:mx-auto' />
                </div>
            </div>
        </div>
    )
